...
using SkymeyOkexTickerList.Actions.GetTickers.Okex;
        ...
        static async Task Main(string[] args)
        {
            ...
            .ConfigureAppConfiguration((hostingContext, config) =>
            {
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddSingleton<GetTickers>();
    ...
    public class MySpecialService : BackgroundService
    {
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            while (!stoppingToken.IsCancellationRequested)
            {
                try
                {
                    await GetTickers.GetCurrentTickersFromOkexSPOT();
                    await GetTickers.GetCurrentTickersFromOkexMARGIN();
                    await GetTickers.GetCurrentTickersFromOkexFUTURES();
