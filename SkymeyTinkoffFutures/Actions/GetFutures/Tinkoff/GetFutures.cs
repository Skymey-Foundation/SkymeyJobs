...
namespace SkymeyTinkoffFutures.Actions.GetFutures.Tinkoff
{
    public class GetFutures
    {
        ...
        public static async Task GetFuturesFromTinkoff()
        {
            var response = investApiClient.Instruments.Futures();
